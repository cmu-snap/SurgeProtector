#ifndef SCHEDULER_HEAPS_FIBONACCI_HEAP_HPP
#define SCHEDULER_HEAPS_FIBONACCI_HEAP_HPP
...
/**
 *  * Implements a min-heap using a Fibonacci heap.
 */
template<class Tag> class FibonacciHeap {
private:
    // Typedefs
...
#endif // SCHEDULER_HEAPS_FIBONACCI_HEAP_HPP
