#ifndef SCHEDULER_HEAPS_PRIORITY_QUEUE_HPP
#define SCHEDULER_HEAPS_PRIORITY_QUEUE_HPP
...
/**
 * Implements a min-heap using a priority queue.
 */
template<class Tag> class PriorityQueue {
private:
    // Typedefs
    using QueueEntry = MinHeapEntry<Tag, double>;
    boost::heap::priority_queue<QueueEntry> queue_;
...
#endif // SCHEDULER_HEAPS_PRIORITY_QUEUE_HPP
